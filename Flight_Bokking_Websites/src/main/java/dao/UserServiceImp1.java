...
public class UserServiceImp1  implements UserInterface{
	...
	public User addUser(User user) {
		...
		{
//		
		String insert_query="insert into user_details(user_name,user_password,"
				+ "user_phone,user_dob,user_address,user_type,user_gender) values(?,?,?,?,?,?,?)";
	...
	public User getLogin(String userName, String password) {
		...
		try(Connection con=DBUtil.getConnect())
		{
			...
			while(rs.next())
			{
				...
				//User(long userId,String userName, String userPassword,String userType,String userAddress
