...
public class FinalEditServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//based on the above input creating the oobject of flight
		
		Flight flight=new Flight(fid,ftype,fsrc,fdest,flayOffs,fdate,fcost);
		//creating the object flightServiceImpl
		FlightServiceImpl service=new FlightServiceImpl();
		
		//invoking method editeFlight(Long fno,Flight newFlight
